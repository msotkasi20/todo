//luodaan konteksti kaikille projektin komponenteille (jakavat tilamuuttujat ja funktiot)
//arvo on user state ja funktiot setUser, signUp ja signIn, joita voidaan käyttää kaikista projektin komponenteista
